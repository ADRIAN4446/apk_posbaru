...
unset($__errorArgs, $__bag); ?>"
                                id="harga_beli" name="harga_beli" value="<?php echo e(old('harga_beli')); ?>" placeholder="0" required>
                        </div>
                        <div class="col-md-6 mb-3">
...
unset($__errorArgs, $__bag); ?>"
                                id="harga_jual" name="harga_jual" value="<?php echo e(old('harga_jual')); ?>" placeholder="0" required>
                        </div>
                    </div>
...
unset($__errorArgs, $__bag); ?>" id="stok"
                                name="stok" value="<?php echo e(old('stok')); ?>" placeholder="0" required>
                        </div>
                        <div class="col-md-6">
