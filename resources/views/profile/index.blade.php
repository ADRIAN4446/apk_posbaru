...
<div class="container py-4" style="max-width: 650px;">
    ...
    <div class="card border-0 shadow-sm rounded-4 p-4" style="background: #ffffff; border: 1px solid #e5e7eb !important;">
        ...
        <form action="{{ route('profile.update') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="name" class="form-control border-start-0 shadow-none" 
                        value="{{ old('name', $user->name) }}" required style="border-color: #e5e7eb;">
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="email" name="email" class="form-control border-start-0 shadow-none" 
                        value="{{ old('email', $user->email) }}" required style="border-color: #e5e7eb;">
                </div>
            </div>
            ...
            {{-- Tombol Aksi --}}
            <a href="{{ url('/dashboard') }}" class="btn btn-outline-secondary px-4 py-2 rounded-3 fw-semibold">
